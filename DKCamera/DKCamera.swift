...
open class DKCamera: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    open func setupUI() {
        ...
        bottomView.frame.origin = CGPoint(x: 0, y: contentView.bounds.height - bottomViewHeight - safeArea.bottom)
        ...
        cancelButton.frame.origin = CGPoint(x: contentView.bounds.width - cancelButton.bounds.width - 15, y: 25 + safeArea.top)
        cancelButton.autoresizingMask = [.flexibleBottomMargin, .flexibleLeftMargin]
        contentView.addSubview(cancelButton)

        self.flashButton.frame.origin = CGPoint(x: 5, y: 15 + safeArea.top)
